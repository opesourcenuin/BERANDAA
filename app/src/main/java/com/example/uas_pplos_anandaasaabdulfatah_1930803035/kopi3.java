...
public class kopi3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopi3);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(kopi3.this, selesai1.class);
    ...
    public void ab(View view) {
        Intent ah = new Intent(kopi3.this, Menu.class);
        startActivity(ah);
    }
}