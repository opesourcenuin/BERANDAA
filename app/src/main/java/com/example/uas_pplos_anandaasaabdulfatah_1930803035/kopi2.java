...
public class kopi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopi2);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(kopi2.this, selesai1.class);
    ...
    public void ab(View view) {
        Intent ah = new Intent(kopi2.this,Menu.class);
        startActivity(ah);
    }
}