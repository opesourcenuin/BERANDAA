...
public class akhir7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akhir7);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(akhir7.this, selesai1.class);
    ...
    public void ah(View view) {
        Intent ah = new Intent(akhir7.this,Menu.class);
        startActivity(ah);
    }
}