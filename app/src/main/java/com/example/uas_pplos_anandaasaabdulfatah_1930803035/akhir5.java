...
public class akhir5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akhir5);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(akhir5.this, selesai1.class);
    ...
    public void af(View view) {
        Intent af = new Intent(akhir5.this,Menu.class);
        startActivity(af);
    }
