...
public class akhir3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akhir3);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(akhir3.this, selesai1.class);
    ...
    public void ad(View view) {
        Intent ad = new Intent(akhir3.this,Menu.class);
        startActivity(ad);
    }
}