...
public class kopi6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopi6);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(kopi6.this, selesai1.class);
    ...
    public void ab(View view) {
        Intent ah = new Intent(kopi6.this, Menu.class);
        startActivity(ah);
    }
}