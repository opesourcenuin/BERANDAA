...
public class kopi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopi4);
        ...
        prosees.setOnClickListener(v -> {
            Intent intent = new Intent(kopi4.this, selesai1.class);
    ...
    public void ab(View view) {
        Intent ah = new Intent(kopi4.this, Menu.class);
        startActivity(ah);
    }
}